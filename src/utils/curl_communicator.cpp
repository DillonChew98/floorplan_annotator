...
CurlCommunicator::CurlCommunicator() : verbose_{false}
{
  curl_handle_ = curl_easy_init();
}

void CurlCommunicator::post_request(const std::string& url, const std::string& infilepath, const std::string& outfilepath,
