#ifndef FLOORPLAN_ANNOTATOR__UTILS__REST_COMMUNICATOR_BASE_HPP_
#define FLOORPLAN_ANNOTATOR__UTILS__REST_COMMUNICATOR_BASE_HPP_
...
#endif  // FLOORPLAN_ANNOTATOR__UTILS__REST_COMMUNICATOR_BASE_HPP_
